<x-staff-app-layout :PageTitle="'Leave'">
                            ...
                            @if ($leaves->isNotEmpty())
                                @foreach ($leaves as $index => $leave)
                                    <tr>
                                        ...
                                        {{-- <td>
                                            <a href="{{ route('staff.leave.edit', $leave->id) }}">
                                                <i class="text-primary fe fe-edit-3 h5"></i>
                                            </a>
                                            <a href="{{ route('staff.leave.destroy', $leave->id) }}" class="mx-3"
                                        ...
                                        <td>
                                            @if ($leave->status == 'Pending')
                                                ...
                                                <a href="{{ route('staff.leave.destroy', $leave->id) }}" class="mx-3" data-confirm-delete="true">
                                                    <i class="text-danger fe fe-trash-2 h5"></i>
                                                </a>
                                            @else
                                                <!-- Disabled Edit and Delete -->
                                                <i class="mx-3 text-muted fe fe-edit-3 h5"></i>
                                                <i class="text-muted fe fe-trash-2 h5"></i>
                                            @endif
                                        </td>
