<x-staff-app-layout :PageTitle="'Edit Subject'">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('staff.subject.update', $subject->id) }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="d-flex align-items-center justify-content-between">
                        <h4 class="card-title">Update Subject</h4>
                        <a href="{{ route('staff.subject.index') }}" type="button" class="btn btn-primary d-flex align-items-center justify-content-between">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Subject Status <span class="text-danger">*</span></label>
