<x-staff-app-layout :PageTitle="'Subject'">
                            ...
                            @if ($subjects)
                                @foreach ($subjects as $index => $subject)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('staff.subject.edit', $subject->id) }}" class="">
                                                <i class="text-primary fe fe-edit-3 h5"></i>
                                            </a>
                                            <a href="{{ route('staff.subject.destroy', $subject->id) }}" class="mx-3"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('staff.subject.store') }}" method="post">
                        @csrf
