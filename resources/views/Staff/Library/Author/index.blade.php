<x-staff-app-layout :PageTitle="'Author'">
                            ...
                            @if ($authors)
                                @foreach ($authors as $index => $author)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('staff.author.edit', $author->id) }}" class="">
                                                <i class="text-primary fe fe-edit-3 h5"></i>
                                            </a>
                                            <a href="{{ route('staff.author.destroy', $author->id) }}" class="mx-3"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('staff.author.store') }}" method="post">
                        @csrf
