<x-staff-app-layout :PageTitle="'Edit Category'">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('staff.category.update', $category->id) }}" method="POST">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('staff.category.index') }}" type="button" class="btn btn-primary d-flex align-items-center justify-content-between">
