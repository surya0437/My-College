...
class StaffRackController extends Controller
{
    /**
    ...
    {
        $racks = Rack::all();
        return view('Staff.Library.Rack.index', compact('racks'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('staff.rack.index');
    ...
    {
        $rack = Rack::find($id);
        return view('Staff.Library.Rack.edit', compact('rack'));
    }
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            return redirect()->route('staff.rack.edit', $id);
        } catch (\Illuminate\Validation\ValidationException $e) {
            $errors = $e->errors();
