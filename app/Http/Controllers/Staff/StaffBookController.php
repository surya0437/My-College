...
class StaffBookController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Staff.Library.Book.index', compact('books', 'categories', 'authors', 'racks'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('staff.book.index');
    ...
    public function edit(string $id)
    {
        ...
        $authors = Author::all();
        $racks = Rack::all();
        return view('Staff.Library.Book.edit', compact('book', 'categories', 'authors', 'racks'));
    }
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            return redirect()->route('staff.book.edit', $id);
        } catch (\Illuminate\Validation\ValidationException $e) {
            $errors = $e->errors();
            ...
            Alert::error('Error!', $error);
            return redirect()->route('staff.book.edit');
        }
    }
